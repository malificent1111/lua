...
[0x68f029]5. [0xffffff]Как купить товар? Ответ — нужно выбрать товар из списка, кликнув далее ввести количество и нажать "Купить". Товар будет добавлен в ваш инвентарь. Если эмов недостаточно - товар нельзя купить.
